...
getStatistics = function(TRADES,WD,cap) {
...
#' @export
#'
generateYearCode = function(TRADES,y,WD,value,isTest = FALSE) {
  yStats = getStatistics(TRADES,WD,value)
  if (isTest) {
